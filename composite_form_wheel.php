...
// no need to urlencode unless perhaps magic quotes is ON (??)
    ...
    echo "<img border='0' src='composite_wheel.php?rx1=$rx1&rx2=$rx2&p1=$ser_L1&p2=$ser_L2&hc1=$ser_hc1&ubt1=$ubt1&ubt2=$ubt2' width='640' height='640'>";
    echo "<br><br>";
    echo "<img border='0' src='composite_aspect_grid.php?rx1=$rx1&rx2=$rx2&p1=$ser_L1&p2=$ser_L2&hc1=$ser_hc1&ubt1=$ubt1&ubt2=$ubt2' width='705' height='450'>";
    echo "</center>";
    echo "<br>";
...
// display composite data - aspect table
    ...
    {
      @mail(EMAIL, "Composite", "");
    }


//display the composite chart report
    if ($no_interps == True)
    {
      include ('footer.html');
      exit();
  ...
  {
    include ('header_composite.html');				//here because of cookies
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" target="_blank" style="margin: 0px 20px;">
  <fieldset><legend><font size=4><b>Data entry for a Composite Chart - Person #1</b></font></legend>
