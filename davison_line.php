...
//display the Davison relationship chart report
    if ($no_interps == True)
    {
      include ('footer.html');
      exit();
    ...
    else
    {
      ...
      @mail(EMAIL, "Davison Relationship", "");
  ...
  {
    include ('header_davison.html');				//here because of cookies
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" target="_blank" style="margin: 0px 20px;">
  <fieldset><legend><font size=4><b>Data entry for a Davison Relationship Chart - Person #1</b></font></legend>
