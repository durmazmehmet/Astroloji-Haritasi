...
class Validate_fields {
	...
	function error_text($num, $fieldname = "") {
		...
		switch ($this->language) {
			...
			break;
			default:
			$msg[0] = "<font size=2 color='#ff0000'>";
			$msg[1] = $fieldname . " alanı boş bırakıldı";
			$msg[10] = "Tarih hatalı";
			$msg[11] = $fieldname . " hatalı.";
			$msg[12] = $fieldname . " hatalı.";
			$msg[13] = $fieldname . " hatalı.";
			$msg[14] = $fieldname . " hatalı.";
			$msg[15] = $fieldname . " hatalı.";
		}
		return $msg[$num];
	}
}
