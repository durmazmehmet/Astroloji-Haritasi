<?php
  ...
  if (isset($_POST['submitted']) Or isset($_POST['h_sys_submitted']))
  {
    ...
    if ($start_month != "" And $start_day != "" And $start_year != "")
    {
      ...
      {
        $my_error .= "The transit/progressed date you entered is not valid.<br />";
      }
    }

    if (($start_year < 1900) Or ($start_year >= 2100))
    {
      $my_error .= "Transit/progressed date - please enter a year between 1900 and 2099.<br />";
    }
...
// no need to urlencode unless perhaps magic quotes is ON (??)
    ...
    echo "<center>";
    //echo "<img border='0' src='transit_prog_wheel.php?rx1=$rx1&rx2=$rx2&rx3=$rx3&p1=$ser_L1&p2=$ser_L2&p3=$ser_L3&hc1=$ser_hc1&hc2=$ser_hc2&hc3=$ser_hc3&ubt1=$ubt1&ubt2=$ubt2&ubt3=$ubt3' width='640' height='640'>";
    echo "<img border='0' src='transit_prog_wheel.php?p1=$ser_L1&p2=$ser_L2&p3=$ser_L3&hc1=$ser_hc1' width='640' height='640'>";
    echo "<br /><br />";
    echo "PROGRESSIONS<br />";
    echo "<img border='0' src='prog_aspect_grid.php?rx1=$rx1&rx2=$rx2&p1=$ser_L1&p2=$ser_L2&hc1=$ser_hc1&hc2=$ser_hc2&ubt1=$ubt1&ubt2=$ubt2' width='830' height='475'>";
    echo "<br />TRANSITS<br />";
...
// display transit data - aspect table
    ...
    {
      @mail(EMAIL, "Transits and Progressions", "");
    }
...
//display the transit chart report
  ...
  {
    include ('header_transits_progressed.html');				//here because of cookies
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" target="_blank" style="margin: 0px 20px;">
  <fieldset><legend><font size=4><b>Data entry for Transits/Progressions - Enter your birth information</b></font></legend>
  ...
  <table style="font-size:12px;">
    <TR>
      <TD>
        <P align="right"><b>Progressed date:</b></P>
      </TD>
