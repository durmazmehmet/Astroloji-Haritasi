...
// no need to urlencode unless perhaps magic quotes is ON (??)
      ...
      echo "<img border='0' src='natal_wheel_2.php?rx1=$rx1&p1=$ser_L1&hc1=$ser_hc1&hpos=$ser_hpos' width='640' height='640'>";
      echo "<br><br>";
...
//display natal data
      ...
      {
        @mail(EMAIL, "Sabian Symbol Report", "");
      }

//display the Sabian chart report
      ...
      //display Sabian symbol interpretation
      //get header first
