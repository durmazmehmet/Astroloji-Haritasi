<?php
  ...
  if (isset($_POST['submitted']) Or isset($_POST['h_sys_submitted']))
  {
    ...
    {
      $my_error .= "Progressed date - please enter a year between 1900 and 2099.<br>";
    }
...
// no need to urlencode unless perhaps magic quotes is ON (??)
    ...
    echo "<center>";
    //echo "<img border='0' src='chartwheel_prog_line.php?rx1=$rx1&rx2=$rx2&p1=$ser_L1&p2=$ser_L2&hc1=$ser_hc1&hc2=$ser_hc2&ubt1=$ubt1&ubt2=$ubt2' width='730' height='400'>";
    echo "<img border='0' src='prog_wheel.php?rx1=$rx1&rx2=$rx2&p1=$ser_L1&p2=$ser_L2&hc1=$ser_hc1&hc2=$ser_hc2&ubt1=$ubt1&ubt2=$ubt2' width='640' height='640'>";
    echo "<br><br>";
...
// display progressed data - aspect table
    ...
    {
      @mail(EMAIL, "Progressions", "");
    }


//display the progressed chart report
    if ($no_interps == True)
    {
      include ('footer.html');
      exit();
    ...
    else
    {
      ...
      for ($i = 0; $i <= 5; $i++)
      {
        for ($j = 0; $j <= 9; $j++)
        {
          ...
          {
            continue;			// do not allow Moon aspects for progressed planets, or for natal planets if birth time is unknown
          }
  ...
  {
    include ('header_progressions.html');				//here because of cookies
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" target="_blank" style="margin: 0px 20px;">
  <fieldset><legend><font size=4><b>Data entry for Progressions - Enter your birth information</b></font></legend>
