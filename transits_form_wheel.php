<?php
  ...
  if (isset($_POST['submitted']) Or isset($_POST['h_sys_submitted']))
  {
    ...
    {
      $my_error .= "Transit date - please enter a year between 1900 and 2099.<br>";
    }
...
// no need to urlencode unless perhaps magic quotes is ON (??)
    ...
    echo "<center>";
    //echo "<img border='0' src='chartwheel_transit_line.php?rx1=$rx1&rx2=$rx2&p1=$ser_L1&p2=$ser_L2&hc1=$ser_hc1&hc2=$ser_hc2&ubt1=$ubt1&ubt2=$ubt2' width='730' height='400'>";
    echo "<img border='0' src='transit_wheel.php?rx1=$rx1&rx2=$rx2&p1=$ser_L1&p2=$ser_L2&hc1=$ser_hc1&hc2=$ser_hc2&ubt1=$ubt1&ubt2=$ubt2' width='640' height='640'>";
    echo "<br><br>";
    echo "<img border='0' src='transit_aspect_grid.php?rx1=$rx1&rx2=$rx2&p1=$ser_L1&p2=$ser_L2&hc1=$ser_hc1&hc2=$ser_hc2&ubt1=$ubt1&ubt2=$ubt2' width='830' height='475'>";
    echo "</center>";
    echo "<br>";
...
//display the transit chart report
  ...
  {
    include ('header_transits.html');				//here because of cookies
